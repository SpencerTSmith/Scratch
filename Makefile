...
ON_WARNINGS := -Werror -Wall -Wextra -Wshadow -Wpointer-arith -Wcast-align -Wredundant-decls
...
taco-rename: bin-folder
	${CC} ${CFLAGS} src/taco_rename.c -o bin/taco_rename.x
	bin/taco_rename.x taco_test.txt

json: bin-folder
	${CC} ${CFLAGS} src/make_haversine_json.c -lm -o bin/make.x
	bin/make.x uniform $$RANDOM 10000000

calc: bin-folder
	${CC} ${CFLAGS} src/calc_haversine.c  -lm -o bin/calc.x
...
test-common: bin-folder
	${CC} ${TEST_FLAGS} src/tests/test_common.c -o bin/test_common.x
	bin/test_common.x

test-arguments: bin-folder
	${CC} ${TEST_FLAGS} src/tests/test_arguments.c -o bin/test_arguments.x
	bin/test_arguments.x positional --verbose -v --foo --bar --baz=foo,bar,boo positional2 --bunk=bip,bop,bam,

test-c-tokenize: bin-folder
	${CC} ${TEST_FLAGS} src/tests/test_c_tokenize.c -o bin/test_c_tokenize.x
	bin/test_c_tokenize.x

test-c-parse: bin-folder
	${CC} ${TEST_FLAGS} src/tests/test_c_parse.c -o bin/test_c_parse.x
	bin/test_c_parse.x

test-linear-algebra: bin-folder
	${CC} ${TEST_FLAGS} src/tests/test_linear_algebra.c -o bin/test_linear_algebra.x
	bin/test_linear_algebra.x

reptest-file-apis: bin-folder
	head -c 1G /dev/urandom > gb_file.txt
	${CC} ${CFLAGS} src/reptests/reptest_file_apis.c -o bin/reptest_file_apis.x
	bin/reptest_file_apis.x gb_file.txt $(TRY_FOR_MIN_TIME)

reptest-page-faults: bin-folder
	${CC} ${CFLAGS} src/reptests/reptest_page_faults.c -o bin/reptest_page_faults.x
...
reptest-loop-dependencies: bin-folder
	...
	${CC} ${CFLAGS} src/reptests/reptest_loop_dependencies.c bin/reptest_loop_dependencies.a -o bin/reptest_loop_dependencies.x
...
reptest-nops: bin-folder
	...
	${CC} ${CFLAGS} src/reptests/reptest_nops.c bin/reptest_nops.a -o bin/reptest_nops.x
...
reptest-branches: bin-folder
	...
	${CC} ${CFLAGS} src/reptests/reptest_branches.c bin/reptest_branches.a -o bin/reptest_branches.x
...
reptest-code-alignment: bin-folder
	...
	${CC} ${CFLAGS} src/reptests/reptest_code_alignment.c bin/reptest_code_alignment.a -o bin/reptest_code_alignment.x
...
reptest-rat: bin-folder
	...
	${CC} ${CFLAGS} src/reptests/reptest_rat.c bin/reptest_rat.a -o bin/reptest_rat.x
...
reptest-read-ports: bin-folder
	...
	${CC} ${CFLAGS} src/reptests/reptest_read_ports.c bin/reptest_read_ports.a -o bin/reptest_read_ports.x
...
reptest-write-ports: bin-folder
	...
	${CC} ${CFLAGS} src/reptests/reptest_write_ports.c bin/reptest_write_ports.a -o bin/reptest_write_ports.x
...
reptest-wide-reads: bin-folder
	...
	${CC} ${CFLAGS} src/reptests/reptest_wide_reads.c bin/reptest_wide_reads.a -o bin/reptest_wide_reads.x
...
reptest-cache-bandwidth: bin-folder
	...
	${CC} ${CFLAGS} src/reptests/reptest_cache_bandwidth.c bin/reptest_cache_bandwidth.a -o bin/reptest_cache_bandwidth.x
	bin/reptest_cache_bandwidth.x $(TRY_FOR_MIN_TIME) granular

reptest-data-alignment: bin-folder
	nasm -f elf64 -o bin/reptest_cache_bandwidth.o src/reptests/reptest_cache_bandwidth.asm
	ar rcs bin/reptest_cache_bandwidth.a bin/reptest_cache_bandwidth.o
	${CC} ${CFLAGS} src/reptests/reptest_data_alignment.c bin/reptest_cache_bandwidth.a -o bin/reptest_data_alignment.x
...
reptest-pathologic-cache: bin-folder
	...
	${CC} ${CFLAGS} src/reptests/reptest_pathologic_cache.c bin/reptest_pathologic_cache.a -o bin/reptest_pathologic_cache.x
...
reptest-non-temporal: bin-folder
	...
	${CC} ${CFLAGS} src/reptests/reptest_non_temporal.c bin/reptest_non_temporal.a -o bin/reptest_non_temporal.x
...
reptest-prefetch: bin-folder
	...
	${CC} ${CFLAGS} src/reptests/reptest_prefetch.c bin/reptest_prefetch.a -o bin/reptest_prefetch.x
	bin/reptest_prefetch.x $(TRY_FOR_MIN_TIME)

reptest-chunk-read: bin-folder
	${CC} ${CFLAGS} src/reptests/reptest_chunk_read.c -o bin/reptest_chunk_read.x
